...
replicas: an informal interface, implementations store the process' replicas. 
    WARNING: Since we provide MPI implementations, DO NOT assume that this will contain all the replicas.

Implementations types provided
...
swap_round!(pair_swapper, replicas, swap_graph) = @abstract 
