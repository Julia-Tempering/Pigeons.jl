...
# ╔═╡ 46553ab9-537b-4e57-8859-6970e9b1a837
using Pigeons

# ╔═╡ 679a01d3-16ea-461d-aa6f-d4bff53b5b1b
using PlutoUI

# ╔═╡ c178a98a-b327-4e04-b3c9-64fa48e3f510
using MCMCChains

# ╔═╡ 5ed71d68-8d2e-48ff-90e2-a14e47237c62
using StatsPlots

# ╔═╡ 2c20fabd-feca-4f09-8f52-bf01de449ddf
pt = pigeons(target = toy_mvn_target(10), record = [traces; record_default()]);

# ╔═╡ 4a679fc3-a9e0-4539-b59d-125d09be15f2


# ╔═╡ 1a83e635-375b-465f-8afa-993033bceb31
samples = Chains(sample_array(pt), variable_names(pt));

# ╔═╡ a522cd91-6633-4488-bf31-705604f5c2db
StatsPlots.plot(samples)

# ╔═╡ e805aabb-dd76-4a8c-a8da-ab30e88aad9c
plot(pt.shared.tempering.communication_barriers.localbarrier)

# ╔═╡ d324c3eb-4e27-4279-a309-789ffd9b3da9


# ╔═╡ a755bae2-f8e0-4f60-b562-3dcf09917f0d


# ╔═╡ e42874f7-5be6-4826-b015-e24c5cbb97e4
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "9ba98ad1b96a48d8ad7f868c53f59381ba71ac8b"
